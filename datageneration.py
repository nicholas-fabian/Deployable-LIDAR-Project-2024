...
files = glob.glob('Front2/*.jpg')      # finds all the pathnames matching a specified pattern
print(files)

# Write (angle,x,y) coordinates of laser spot to file
# for post-processing
f = open('Front2/testresults.txt', 'a')
...
ax.scatter(np.array(pcX, dtype="int32"), np.array(pcY, dtype="int32"), np.array(pcZ, dtype="int32"), s=1)
